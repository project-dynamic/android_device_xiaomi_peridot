git clone https://gitlab.com/sm8635-peridot/proprietary_vendor_xiaomi_peridot-miuicamera.git vendor/xiaomi/peridot-miuicamera
...
git clone https://github.com/LineageOS/android_kernel_xiaomi_sm8635-modules kernel/xiaomi/sm8635-modules

git clone https://github.com/LineageOS/android_kernel_xiaomi_sm8635 kernel/xiaomi/sm8635
